...
const (
	...
	ServerTenantMigrate          = "server.tenant_migrate"
	...
	ServerFTPCredentialRotate    = "server.ftp_credential_rotate"
	ServerFTPEnable              = "server.ftp_enable"
	ServerFTPDisable             = "server.ftp_disable"
	...
	SettingsEmailTest            = "settings.email_test"
