...
const (
	...
	CapabilityEggContainerRuntime     Capability = "egg_container_runtime"
...
// internal Go type information"). CapabilityEggContainerRuntime is included
// unconditionally, the same way CapabilityContainerRuntime is: both describe
// what this compiled build supports, not runtime engine availability, and
// this package never imports internal/templates or internal/provisioning to
// determine it.
